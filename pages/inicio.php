...
<section class="section-content">
    ...
    Análisis y Diseño de Sistema de Venta y Gestión de Productos Yumara Supermarket</h2>
    ...
    <div class="text-center mb-4">
        <img src="img/Sistema.jpg" alt="Logo Yumara" style="width: 600px; height: auto;">
        <p>Imagen representativa del sistema de ventas y administración de productos</p>
    </div>

    <div class="text-center mb-4">
    <img src="img/Productos.jpg" alt="Logo Yumara" style="width: 600px; height: auto;">
